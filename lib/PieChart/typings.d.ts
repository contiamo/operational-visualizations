...
import { Accessor, BaseConfig, ChartStateReadOnly, D3Selection, Dimensions, Facade, Focus, Legend } from "../shared/typings";
...
export declare type State = ChartStateReadOnly<Data, PieChartConfig, AccessorsObject, Computed>;
...
export declare type InputData = InputDatum[];
...
export declare type RendererAccessor<T> = Accessor<InputDatum | ComputedDatum, T>;
...
export declare type Facade = Facade<PieChartConfig, Data>;
export interface RendererOptions {
    type: RendererType;
    accessors?: {
        [key: string]: Accessor<Datum, any>;
    };
    extent?: "semi" | "full";
...
export declare type RendererType = "donut" | "polar" | "gauge";
