...
const data: Data = {
  ...
  axes: {
    y1: {
      type: "categorical",
      values: [
        new Date(2018, 2, 10).toString(),
        new Date(2018, 2, 11).toString(),
        new Date(2018, 2, 12).toString(),
        new Date(2018, 2, 13).toString(),
        new Date(2018, 2, 14).toString(),
        new Date(2018, 2, 16).toString(),
        new Date(2018, 2, 17).toString(),
      ],
      title: "2018",
    },
    x1: {
...
export const marathon = ({ test, afterAll, container }: MarathonEnvironment): void => {
  ...
  test("Assign widths", () => {
    const barWidth = (series: any) => (series.key() === "series1" ? 20 : 10);
    viz.data(
      createData([
        {
          accessors: {
