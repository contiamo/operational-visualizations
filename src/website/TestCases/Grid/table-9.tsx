        ...
        {({ width, height }) => (
          <NewGrid
            ...
            cell={({ data, measure }: any) => {
              ...
              return (
                <BarChart width={100} height={100} data={cell} layout="horizontal">
                  <Tooltip labelFormatter={() => undefined} formatter={(x, _, z) => [x, z.payload["Customer.City"]]} />
                  <Bar dataKey={measure} fill="#82ca9d" layout="horizontal" />
                </BarChart>
              );
            }}
          />
...
export const title: string = "New Grid with recharts";

// Must match the file name so we can link to the code on GitHub
export const slug = "table-9";
