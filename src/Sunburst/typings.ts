...
export type State = ChartStateReadOnly<Data, SunburstConfig, AccessorsObject, Computed>;
...
export type HierarchyDatum = HierarchyRectangularNode<ProcessedData>;
...
export type Facade = Facade<SunburstConfig, Data>;
